...
void Renderer::init()
{
	...
	std::cout << "V| Initalized Renderer!\n";
}
...
Camera* Renderer::newCamera(SPC_Transform t)
{
	Camera* n = new Camera(t);
	return n;
}
Renderable* Renderer::newRenderable(SPC_Transform t)
{
	Renderable* r = new Renderable(t,m_meshes.find("cube.obj")->second,basic);
	return r;
}
