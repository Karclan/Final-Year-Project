...
void Scene::test()
{
	...
	rotating_3Dcube->rotate(glm::vec3(_controllerInput._rightStick.y*Timer::getTime(),_controllerInput._rightStick.x*Timer::getTime(),0.f));
}

void Scene::setUpCameras()
{
	C.baseShaderID = s.shaderProgID;
